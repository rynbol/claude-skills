...
name: ultrathink
description: >
  Orchestrate a deep-thinking multi-agent workflow for complex tasks.
  Use for ambitious implementation tasks, hard bugs, architectural decisions,
  or any problem that benefits from structured reasoning with multiple perspectives.
